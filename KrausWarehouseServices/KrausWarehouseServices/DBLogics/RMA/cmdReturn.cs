...
namespace KrausWarehouseServices.DBLogics.RMA
{
    ...
    public class cmdReturn
    {
        ...
        public Boolean UpsertReturnTbl(ReturnDTO returnDTO)
        {
            ...
            try
            {
                ...
                if (_returnObj == null)
                {
                    ...
                    _returnObj.Exported_in_ERP = returnDTO.Exported_in_ERP;
                    _returnObj.Ready_To_Export = returnDTO.Ready_To_Export;
                    _returnObj.CallTag = returnDTO.CallTag;

                    _returnObj.ProgressFlag = returnDTO.ProgressFlag;
        ...
        public Boolean UpsertReturnTblByRGANewNUmber(ReturnDTO returnDTO)
        {
            Boolean _status = false;
            ...
            {
                Return _returnObj = new Return();
                _returnObj = entRMA.Returns.SingleOrDefault(ret => ret.RGAROWID == returnDTO.RGAROWID);
