...
namespace KrausWarehouseServices.Service.Shipping
{
    ...
    public interface IGet
    {
        ...
        [OperationContract]
        List<DTO.Shipping.PackageBoxTrackingDTO> GetAllPackageBoxTrackings(String ShippingNumber);
        #endregion


        #region ShipmentDetailPageGrid1DTO
        [OperationContract]
        List<DTO.Shipping.ShipmentDetailPageGrid1DTO> GetAllShipmentDetailPageGrid1s(String Date);

        [OperationContract]
        List<DTO.Shipping.ShipmentDetailPageGrid1DTO> GetAllShipmentDetailPageGrid1Totals(String Date);

        [OperationContract]
        [WebInvoke(Method = "GET", UriTemplate = "/GetAllShipmentDetailPageGrid1ByDateSearchs?ID={Date1}&value={Date2}", ResponseFormat = WebMessageFormat.Xml, BodyStyle = WebMessageBodyStyle.Bare)]
        List<DTO.Shipping.ShipmentDetailPageGrid1DTO> GetAllShipmentDetailPageGrid1ByDateSearchs(String Date1, String Date2);

        [OperationContract]
        [WebInvoke(Method = "GET", UriTemplate = "/GetAllShipmentDetailPageGrid1ByDateSearchExpecteds?ID={Date1}&value={Date2}", ResponseFormat = WebMessageFormat.Xml, BodyStyle = WebMessageBodyStyle.Bare)]
        List<DTO.Shipping.ShipmentDetailPageGrid1DTO> GetAllShipmentDetailPageGrid1ByDateSearchExpecteds(String Date1, String Date2);
        #endregion
        ...
        [OperationContract]
        List<DTO.Shipping.ShippingDTO> ShippingWithAllPackage();
        ...
        [OperationContract]
        List<UserTotalPacked> GetEachUserPacked(DateTime DateReport);
