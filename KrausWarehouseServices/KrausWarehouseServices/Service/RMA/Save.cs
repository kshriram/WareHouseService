...
namespace KrausWarehouseServices.Service.RMA
{
    ...
    public class Save : ISave
    {
        ...
        public bool ReturnByRGANumber(DTO.RMA.ReturnDTO _return)
        {
            return _returnobj.UpsertReturnTblByRGANewNUmber(_return);
        }
        ...
        public bool SKUReasons1(DTO.RMA.SKUReasonsDTO SKU)
        {
            return _SKUnumber.UpsertSKUReasons1(SKU);
        }
        ...
        public bool InsertRMAComment(DTO.RMA.RMACommentDTO Commnet)
        {
          return  _comment.insertComment(Commnet);
        }
    }
}
