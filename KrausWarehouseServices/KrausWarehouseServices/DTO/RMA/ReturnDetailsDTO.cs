   ...
   public class ReturnDetailsDTO
    {
        public ReturnDetailsDTO(ReturnDetail ReturnDetails)
        {
            ...
            if (ReturnDetails.ProductID != null) this.ProductID = ReturnDetails.ProductID;
            if (ReturnDetails.SalesPrice != null) this.SalesPrice = ReturnDetails.SalesPrice;

            if (ReturnDetails.LineType != null) this.LineType = ReturnDetails.LineType;

            if (ReturnDetails.ShipmentLines != null) this.ShipmentLines = ReturnDetails.ShipmentLines;
            if (ReturnDetails.ReturnLines != null) this.ReturnLines = ReturnDetails.ReturnLines;

            if (ReturnDetails.TrackingNumber != null) this.TrackingNumber = ReturnDetails.TrackingNumber;
